...
class CustomEnv(gym.GoalEnv):
    ...
    def __init__(self, render=False, base_path=os.getcwd(), car_type='husky', mode='7', manual=False, multi_obs=False, render_video=False):
        """
        初始化环境
        ...
        self.mode = mode
        assert self.mode in ['1', '2', '3', '4', '5', '6', '7']
    ...
    def reset(self):
        ...
        # p.addUserDebugLine([3.5, 3.5, 0.02], [3.5, -3.5, 0.02], [0.75, 0.75, 0.75], 5)
        # p.addUserDebugLine([3.5, 3.5, 0.02], [-3.5, 3.5, 0.02], [0.75, 0.75, 0.75], 5)
        p.addUserDebugLine([-5, -3.75, 0.02], [5, -3.75, 0.02], [0, 0, 0], 5)

        p.addUserDebugLine([-5, -1.75, 0.02], [-4, -1.75, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([5, -1.75, 0.02], [4, -1.75, 0.02], [0, 0, 0], 5)

        p.addUserDebugLine([-4.5, 4.25, 0.02], [-4.5, -1, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([4.5, 4.25, 0.02], [4.5, -1, 0.02], [0, 0, 0], 5)

        p.addUserDebugLine([-4, -1.75, 0.02], [-4.5, -1, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([4, -1.75, 0.02], [4.5, -1, 0.02], [0, 0, 0], 5)

        p.addUserDebugLine([-2.5, 4.25, 0.02], [-2.5, 3.25, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([2.5, 4.25, 0.02], [2.5, 3.25, 0.02], [0, 0, 0], 5)

        p.addUserDebugLine([-1.5, 3.75, 0.02], [-2.5, 3.25, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([1.5, 3.75, 0.02], [2.5, 3.25, 0.02], [0, 0, 0], 5)

        p.addUserDebugLine([-1.5, 3.75, 0.02], [1.5, 3.75, 0.02], [0, 0, 0], 5)

        p.addUserDebugLine([-1.5, 1.75, 0.02], [1.5, 1.75, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([-1.5, 1.75, 0.02], [-2.5, 1, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([1.5, 1.75, 0.02], [2.5, 1, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([-2.5, 1, 0.02], [-2.5, -1, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([2.5, 1, 0.02], [2.5, -1, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([-1.5, -1.75, 0.02], [-2.5, -1, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([1.5, -1.75, 0.02], [2.5, -1, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([-1.5, -1.75, 0.02], [-0.5, -1.75, 0.02], [0, 0, 0], 5)

        p.addUserDebugLine([-0.5, -1.75, 0.02], [-2, 0.75, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([1.5, -1.75, 0.02], [0, 0.75, 0.02], [0, 0, 0], 5)
        p.addUserDebugLine([-2, 0.75, 0.02], [0, 0.75, 0.02], [0, 0, 0], 5)
        ...
        # mode = 7 ()
        if self.mode == '7':  ###
            self.left_wall4 = p.loadURDF(os.path.join(self.base_path, "assets/down/side_boundary_rd2.urdf"),
                                         basePosition=[-1.25, -0.5, 0.03], useFixedBase=10)
            self.right_wall4 = p.loadURDF(os.path.join(self.base_path, "assets/down/side_boundary_rd2.urdf"),
                                          basePosition=[0.75, -0.5, 0.03], useFixedBase=10)
            self.front_wall4 = p.loadURDF(os.path.join(self.base_path, "assets/down/front_boundary_rd2.urdf"),
                                          basePosition=[-1, 0.75, 0.03], useFixedBase=10)
        # else:
        #     p.loadURDF(os.path.join(self.base_path, "assets/down/side_boundary_rd.urdf"), basePosition=[1.6, -2.15, 0.03], useFixedBase=10)
        #     p.loadURDF(os.path.join(self.base_path, "assets/down/side_boundary_rd.urdf"), basePosition=[2.9, -2.15, 0.03], useFixedBase=10)
        #     p.loadURDF(os.path.join(self.base_path, "assets/down/front_boundary_rd.urdf"), basePosition=[2.55, -2.8, 0.03], useFixedBase=10)
        ...
        if self.mode == '1':
            ...
            self.goal = np.array([-0.5 / 2, -1 / 2])
            self.start_orientation = [0, 0, np.pi * 2 / 2]
            self.target_orientation = 2.070143
            basePosition = [3.5, -2.75, 0.2]
        elif self.mode == '6':
            self.goal = np.array([-3.8 / 2, 4.2 / 2])
